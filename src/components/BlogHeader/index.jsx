...
function BlogHeader() {
	...
	return (
		<>
			<header className="lg:max-w-[300px] lg:w-[300px] w-full lg:h-screen sticky top-0 lg:fixed lg:top-0 lg:left-0 bg-background dark:bg-[#0a0a0a] border-b lg:border-b-0 lg:border-r border-black/10 dark:border-white/10 flex flex-col justify-between px-6 md:px-8 py-8 z-40 lg:z-40">
				...
				<nav className="hidden lg:flex flex-col space-y-6">
					...
					<div className="h-px w-12 bg-zinc-300 dark:bg-zinc-800 my-2"></div>
					<Link
						to="/blog"
