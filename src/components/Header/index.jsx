...
function Header() {
	...
	return (
		<>
			<header className="lg:max-w-[300px] lg:w-[300px] w-full lg:h-screen sticky top-0 lg:fixed lg:top-0 lg:left-0 bg-background dark:bg-[#0a0a0a] border-b lg:border-b-0 lg:border-r border-black/10 dark:border-white/10 flex flex-col justify-between px-6 md:px-8 py-8 z-40">
				...
				<nav className="hidden lg:flex flex-col space-y-6">
					<a
						href="#home"
						className="text-zinc-600 dark:text-zinc-400 hover:text-black dark:hover:text-white transition-colors text-lg hover-line w-max"
					>
						01 Intro
					</a>
					<a
				...
				<div className="hidden lg:flex flex-col gap-4">
					...
					<div className="flex gap-4 text-zinc-600 dark:text-zinc-500">
						<a
